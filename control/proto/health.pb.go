...
func (x *HealthResponse) GetValue() bool {
	if x != nil {
		return x.Value
	}
	return false
...
const file_health_proto_rawDesc = "" +
	"\n" +
	"\fhealth.proto\x12\x11net.mioyi.lucuskv\"\x0f\n" +
	"\rHealthRequest\"&\n" +
...
var file_health_proto_goTypes = []any{
	(*HealthRequest)(nil),  // 0: net.mioyi.lucuskv.HealthRequest
	(*HealthResponse)(nil), // 1: net.mioyi.lucuskv.HealthResponse
}
var file_health_proto_depIdxs = []int32{
	0, // 0: net.mioyi.lucuskv.StorageService.Health:input_type -> net.mioyi.lucuskv.HealthRequest
	1, // 1: net.mioyi.lucuskv.StorageService.Health:output_type -> net.mioyi.lucuskv.HealthResponse
